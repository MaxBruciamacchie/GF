...
gf_AgregMoySdEr <- function(df, Regroup="Strate", var.sup=NULL, debut=4, ncol=5) {
  ...
  if (length(var.sup)>0) {
    fmla <- as.formula(paste(fmla,var.sup,sep=" + "))
  } else {
  ...
  CV <- b/Moy*100
  Er <- qt(0.975, Nbre$Nbre)* b/Nbre$Nbre^0.5 * 100
...
tab <- gfPlaDen[,c(1:7,11)] #df <-tab
gfDendroForet <- gf_AgregMoySdEr(tab,"Foret")
gfDendroGroupe <- gf_AgregMoySdEr(tab,"Groupe")
gfDendroStrate <- gf_AgregMoySdEr(tab,"Strate")
gfDendroStation <- gf_AgregMoySdEr(tab,"Station")
gfDendroTypo <- gf_AgregMoySdEr(tab,"Typologie")
gfDendroGroupe1 <- gf_AgregMoySdEr(tab,"Groupe1")
gfDendroGroupe2 <- gf_AgregMoySdEr(tab,"Groupe2")

# ---------- Agregation économie ----------
tab <- gfPla[,c(1:3,8:10)]
...
tab <- gfPlaEss[,c(1:8,12)]
gfDendroEss <- gf_AgregMoySdEr(tab,"Foret",var.sup="Essence")
gfDendroEssDen <- gf_AgregMoySdEr(tab,"Foret",var.sup="Essence")
tab <- gfPlaEss[,c(1:4,9:11)]
...
tab <- gfPlaEssReg[,c(1:8,12)]
gfDendroEssReg <- gf_AgregMoySdEr(tab,"Foret",var.sup="EssReg")
gfDendroEssRegDen <- gf_AgregMoySdEr(tab,"Foret",var.sup="EssReg") #Prendre que Den ? (prend en compte perches)
tab <- gfPlaEssReg[,c(1:4,9:11)]
...
gfRegeEss <- gf_AgregMoySdEr(gfRegePlaEss[,c(1:2,4:9)],"Foret",var.sup="Essence",ncol=4)
gfRegeEssReg <- gf_AgregMoySdEr(gfRegePlaEssReg,"Foret",var.sup="EssReg",ncol=4)

# --------- Histogrammes Catégories, Qualités -------
gfDendroCat <- gf_AgregMoySdEr(gfPlaCatDen[,c(1:8,12)],"Foret",var.sup="Cat")
gfDendroCatEssReg <- gf_AgregMoySdEr(gfPlaCatEssRegDen[,c(1:9,13)],"Foret",var.sup=c("Essence","Cat"))
gfDendroCatQual1 <- gf_AgregMoySdEr(gfPlaCatQual1[,c(1:9,13)],"Foret",var.sup=c("Reg1","Cat"))
gfDendroCatQual2Den <- gf_AgregMoySdEr(gfPlaCatQual2Den[,c(1:9,13)],"Foret",var.sup=c("Reg2","Cat"))

gfEcoCat <- gf_AgregMoySdEr(gfPlaCatDen[,c(1:4,9:11)],"Foret",var.sup="Cat")
gfEcoCatEssReg <- gf_AgregMoySdEr(gfPlaCatEssRegDen[,c(1:5,10:12)],"Foret",var.sup=c("Essence","Cat"))
gfEcoCatQual1 <- gf_AgregMoySdEr(gfPlaCatQual1[,c(1:5,10:12)],"Foret",var.sup=c("Reg1","Cat"))
gfEcoCatQual2Den <- gf_AgregMoySdEr(gfPlaCatQual2Den[,c(1:5,10:12)],"Foret",var.sup=c("Reg2","Cat"))
...
# 		 gfCatQual1Moy,gfEssRegQual1Moy,
# 		 TabPla,TabPlaDen,TabDenGroupe,TabDenGroupeHorsCharme,
# 		 TabPlaCat,TabPlaCatDen,gfPlaCatEssReg,gfPlaCatEssRegDen,gfCatEssRegMoy,TabPlaCatQual1,TabPlaCatQual2,TabPlaCatQual2Den,
# 		 TabPlaClasseQual1,TabPlaClasseQual1Den,TabPlaClasseQual2,TabPlaClasseQual2Den,gfPlaEssRegQual1,gfPlaEssRegQual2,
# 		 gfPlaEss,gfPlaEssDen,gfEssMoy,gfPlaEssReg,gfPlaEssRegDen,gfPlaEssRegQual,gfPlaEssRegQualDen,gfClasseEssRegMoy,TabEssRegMoy,
# 		 Reges, RegePlaEss, RegeEss,
#      Taillis, gfTaillisEss, gfTaillisEssReg, TaillisPla, gfTaillisPlaEssReg,
#      file="Tables/GFTablesElaborees.RData")
